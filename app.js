...
// Generación y captura del Recibo Dinámico (Estilo Factura Integrado y Mejorado)
if (btnCapture) {
    btnCapture.addEventListener('click', () => {
        ...
        recibo.style.fontFamily = "'Courier New', Courier, monospace"; 
        ...
        // Configuración dinámica de etiquetas y símbolos según la tasa seleccionada
        let etiquetaRecibo = 'USD';
        let simboloRecibo = '$';
        if (tipoTasaActual === 'euro') { 
            etiquetaRecibo = 'EUR'; 
            simboloRecibo = '€'; 
        } else if (tipoTasaActual === 'usdt') { 
            etiquetaRecibo = 'USDT'; 
            simboloRecibo = '₮'; 
        }
        ...
        recibo.innerHTML = `
            ...
            <table style="width: 100%; font-size: 13px; border-collapse: collapse; color: #333;">
                ...
                <tr style="font-size: 15px;">
                    <td style="padding: 6px 0; text-align: left;"><strong>Monto ${etiquetaRecibo}:</strong></td>
                    <td style="padding: 6px 0; text-align: right; font-weight: bold; color: #1b5e20;">${simboloRecibo} ${inputUsd.value || '0,00'}</td>
                </tr>
                <tr style="font-size: 15px;">
                ...
                canvas.toBlob(blob => {
                    ...
                    if (navigator.share && navigator.canShare && navigator.canShare({ files: [file] })) {
                        navigator.share({
                            ...
                            text: `Conversión: ${simboloRecibo}${inputUsd.value || '0,00'} = Bs. ${inputVes.value || '0,00'}`
                        })
...
// Función auxiliar para descarga directa (Fallback del recibo)
